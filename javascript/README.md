...
##Extra Credit: 
  ...
  New Features:
     ...
     > Think of features that may be useful and build it! Try putting the current date and
     > time somewhere in the app. Maybe get the current weather stats for your current
     > location...
